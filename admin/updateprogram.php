...
<?php
    ...
    if (isset($_POST["updateCourse"])) {
        ...
        $updateSubjectName = $_POST["subjectName"];
        $updateYearLevel = $_POST["yearLevel"];

        $checkDuplicateCode = "SELECT * FROM subject WHERE $updateSubjectCode = subjectcode";
        $rowCheck = mysqli_query($connect, $checkDuplicateCode);

        $updateSubjectDetails = "UPDATE subject SET subjectname = '".$updateSubjectName."',
            subjectcode = '".$updateSubjectCode."',
            yearlevel = '".$updateYearLevel."'
            WHERE $courseID = id ";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Update Subject</h1>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <form method="POST" action="">
                                    <?php
                                        ...
                                        $updateSubject = "SELECT * FROM subject WHERE $courseID = id";
                                        $conUpdateSubject = mysqli_query($connect, $updateSubject);

                                        while ($rowUpdateSubject = mysqli_fetch_array($conUpdateSubject)) {
                                            $subjectName = $rowUpdateSubject["subjectname"];
                                            $yearLevel = $rowUpdateSubject["yearlevel"];
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="" 
                                                value="<?php echo $subjectCode; ?>" name="subjectCode" id="subjectCode">
                                        </div>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                        ...
                                        <input type="submit" class="btn btn-primary btn-user btn-block" 
                                            name="updateCourse" id="updateCourse" value="Update">
                                    </div>
