...
<?php
    ...
    if (isset($_POST["remove"])) {
        //$_GET["studentnumber"] came from viewstudents.php GET from URL
        $studentNumberHere = $_GET["studentnumber"];
        //$removeStudent = mysqli_query($connect, "DELETE FROM users WHERE {$studentNumberHere} = id");
        
        $removeStudent = "DELETE FROM users WHERE {$studentNumberHere} = id";
        if (mysqli_query($connect, $removeStudent)) {
            echo "<script> alert('Student removed from records.'); </script>";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Remove Student</h1>
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        while ($rowResult = mysqli_fetch_array($studentResult)) {
                                            ...
                                            $phoneNumber = $rowResult["phonenumber"];
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $rowResult["id"]; ?>" 
                                            placeholder="" name="" id="" readonly>
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $rowResult["email_address"]; ?>" 
                                            placeholder="" name="" id="" readonly>
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $rowResult["phonenumber"]; ?>" 
                                            placeholder="" name="" id="" readonly>
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $rowResult["gender"]; ?>" 
                                            placeholder="" name="" id="" readonly>
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $rowResult["birthday"]; ?>" 
                                            placeholder="" name="" id="" readonly>
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" class="form-control" value="<?php echo $rowResult["address"]; ?>" 
                                            placeholder="" name="" id="" readonly>
                                    </div>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="">Program:</span>
                                        </div>
                                        <input type="text" class="form-control" value="<?php echo $rowResult["program"]; ?>" 
                                            placeholder="" name="" id="" readonly>
                                    </div>
                                    <?php
                                            // echo "<p>Student ID: " . $id . "</p>";
                                            // echo "<p>Full name: " . $rowResult["lastname"] . ", " . $rowResult["firstname"] . "</p>";
                                    ...
                                    <input type="submit" class="btn btn-primary btn-user btn-block" name="remove" id="remove" value="Remove Student">
                                    </form>
                                </div>
                            </div>
                            <!-- remove student section -->
